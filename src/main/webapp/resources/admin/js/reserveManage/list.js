reserveManageList = {
	...
	,changeDateTime : function(changeTimeList, timeList){
		...
		if(timeList.length > 0){
			...
			while(i < timeList.length){
					...
					let reserveParam = {"rlIdx" : timeList[i].rl_idx, "rlName" : timeList[i].rl_name, "rlHp" : timeList[i].rl_hp, "rlStatus" : timeList[i].rl_status, "isAudio" : timeList[i].is_audio}
				...
				if(jQuery.inArray(timeList[i], _this.reserveList, rangeIdx) > -1){
					...
					if(prevRlIdx != rlIdx){						
						...
						switch(_this.todayStatus){
							case -1 :
								rlStatusTxt = '상담종료';
								$('.time_list tbody').append('<tr class="not_reserve"><td>' + rlStatusTxt + '</td><td>' + rlName + '</td><td>' + rlHp + '</td><td>' + timeList[i] + '</td><td>' + rlStatusTxt + '</td><td><a href="javascript:void(0)" class="mr5 admin_btn_style_1" onclick="reserveManageList.updateReserve(' + rlIdx + ',1)"><span>대기</span></a><a href="javascript:void(0)" class="admin_btn_style_1 grey" onclick="reserveManageList.updateReserve(' + rlIdx + ',3)"><span>종료</span></a></td><td><a href="javascript:void(0)" onclick="reserveManageList.playAudio(' + rlIdx + ')" class="admin_btn_style_1">실행</a></td></tr>');
								break;
							case 0 :
								switch(rlStatus){
									case 2 :
									...
									case 3 :
										rlStatusTxt = '상담종료';
										$('.time_list tbody').append('<tr class="not_reserve"><td>' + rlStatusTxt + '</td><td>' + rlName + '</td><td>' + rlHp + '</td><td>' + timeList[i] + '</td><td><a href="javascript:void(0)" class="mr5 admin_btn_style_1" onclick="reserveManageList.updateReserve(' + rlIdx + ',1)"><span>대기</span></a><a href="javascript:void(0)" class="admin_btn_style_1 skyblue" onclick="reserveManageList.updateReserve(' + rlIdx + ',2)"><span>시작</span></a></td><td><a href="javascript:void(0)" onclick="reserveManageList.playAudio(' + rlIdx + ')" class="admin_btn_style_1">실행</a></td></tr>');
										break;
									default :
										$('.time_list tbody').append('<tr class="not_reserve"><td>' + rlStatusTxt + '</td><td>' + rlName + '</td><td>' + rlHp + '</td><td>' + timeList[i] + '</td><td><a href="javascript:void(0)" class="mr5 admin_btn_style_1 skyblue" onclick="reserveManageList.updateReserve(' + rlIdx + ',2)"><span>시작</span></a><a href="javascript:void(0)" class="admin_btn_style_1 grey" onclick="reserveManageList.updateReserve(' + rlIdx + ',3)"><span>종료</span></a></td><td><a href="javascript:void(0)" onclick="reserveManageList.playAudio(' + rlIdx + ')" class="admin_btn_style_1">실행</a></td></tr>');
										break;
							...
							case 1 :
								rlStatusTxt = '상담대기';
								$('.time_list tbody').append('<tr class="not_reserve"><td>' + rlStatusTxt + '</td><td>' + rlName + '</td><td>' + rlHp + '</td><td>' + timeList[i] + '</td><td>' + rlStatusTxt + '</td><td><a href="javascript:void(0)" onclick="reserveManageList.playAudio(' + rlIdx + ')" class="admin_btn_style_1">실행</a></td></tr>');
								break;
							default :
								break;
						}
					...
					if(prevPossibleTimeVal != timeList[i]){
						...
						if(_this.todayStatus > -1){
							$('.time_list tbody').append('<tr><td>예약가능</td><td>없음</td><td></td><td>' + timeList[i] + '</td><td><a href="javascript:void(0)" class="admin_btn_style_1" onclick="reserveManageList.insertReserve(\'' + timeList[i] + '\')"><span>예약등록</span></a></td><td></td></tr>');
						} else {
							$('.time_list tbody').append('<tr><td>상담종료</td><td>없음</td><td></td><td>' + timeList[i] + '</td><td>상담종료</td><td></td></tr>');
						}
	...
	,playAudio(rlIdx){
		...
		if(confirm('실행시키겠습니까?')){
			...
			$.ajax({
				url : "/reserve/adm/reserveManage/updateAudio"
				,contentType : 'application/json; charset=UTF-8'
				,dataType : "json"
				,data : params
				,type : "post"
