    	...
    	<div class="col-12 admin_contents">
			<div class="col-12 admin_card_list_style_0_wrap">
				<div class="col-12 admin_card_list_style_0_con">
					...
					<div class="col-6 col-md-4 col-lg-3 col-xl-20 admin_card_list_style_0">
						<div class="col-12 admin_card_list_style_0_inner">
							...
							<div class="col-12 mt20 btn_con">
								<a href="/reserve/adm/branchManage/update?br_idx=${list.brIdx}" class="col-12 admin_btn_style_0">
									<span>지점관리</span>
								</a>
							</div>
						</div>
					...
					<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-20 admin_card_list_style_0 plus_btn">
						<a href="/reserve/adm/branchManage/insert" class="col-12 admin_card_list_style_0_inner">
						</a>
					</div>
				</div>
			</div>
