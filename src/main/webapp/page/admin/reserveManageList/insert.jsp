    	...
    	<div class="col-12 admin_contents_con">
	    	...
	    	<div class="col-12 admin_contents">
				<div class="col-12 admin_form_style_0_wrap">
					<form class="col-12 admin_form_style_0_con" action="/reserve/adm/reserveManageList/insertAction" method="post" data-common-update-form>
							...
							<div class="col-12 col-md-0 input_box">
								<div class="col-12 mw-200 admin_select_style_0_wrap">
									<select name="rlBusinessType" id="rlBusinessType" class="admin_select_style_0">
										<option value="1" selected>개인사업자</option>
						...
						<div class="col-12 admin_form_style_0">
							...
							<div class="col-12 col-md-0 input_box">
								<div class="col-12 mw-200 admin_input_style_0_con">
									<input type="text" class="admin_input_style_0" value="" data-common-update-essential-input="방문일자를 선택해주세요" name="rlReserveDate" id="rlReserveDate" autocomplete="off" data-common-datepicker readonly/>
								</div>
							</div>
						</div>
						<div class="col-12 admin_form_style_0">
