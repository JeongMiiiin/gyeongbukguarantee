...
<form method="get" id="filterForm" action="/reserve/adm/inquiryIpManage/list" class="col-12 admin_filter_style_0_wrap" data-common-filter-form>
	...
	<div class="col-12 col-lg-0 admin_filter_style_0_btn_con">
		<a href="/reserve/adm/inquiryIp/list" class="admin_btn_style_0 mr5">
			<span>초기화</span>
		</a>
		<a href="javascript:void(0)" class="admin_btn_style_0" data-common-filter-btn>
			<span>검색</span>
		</a>
	</div>
</form>